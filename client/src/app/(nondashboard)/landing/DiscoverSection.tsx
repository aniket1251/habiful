               ...
               {[
                {
                    ...
                    description:"Browse a wide selection of rental homes across cities and neighborhoods that match your preferences."
                },
                {
                    imageSrc:"/landing-icon-calendar.png",
                     title:"Book Your Rentals",
                    description:"Shortlist, compare, and book your rental with a smooth and transparent process."
                },
                {
                    imageSrc:"/landing-icon-heart.png",
                     title:"Move In & Settle",
                    description:"Step into your new home and start living comfortably from day one."
                },
               ].map((card,index)=>(
