              ...
              <FeatureCard
                ...
                title={
                  [
                    ...
                    "Simplify Your Rental Search With Advanced Searching",
                  ][index]
                }
                description={
                  [
                    "Browse verified rental listings backed by real reviews, so you can choose with confidence.",
                    "Powerful filters and an intuitive interface help you find homes that truly fit your requirements.",
                    "Smart search tools designed to save time and remove friction from your rental journey.",
                  ][index]
                }
