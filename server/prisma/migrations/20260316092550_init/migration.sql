...
-- AddForeignKey
ALTER TABLE "RefreshToken" ADD CONSTRAINT "RefreshToken_manager_fkey" FOREIGN KEY ("userId") REFERENCES "Manager"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RefreshToken" ADD CONSTRAINT "RefreshToken_tenant_fkey" FOREIGN KEY ("userId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
